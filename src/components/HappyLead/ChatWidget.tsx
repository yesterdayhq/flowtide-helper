...
export function ChatWidget() {
  ...
  const handleButtonClick = async (action: string) => {
    ...
    const responses: Record<string, string> = {
      show_tip: 'Try dragging the screenshot into the step area and click Save — that usually fixes it.',
      decline_help: "No problem — I'll be here if you need anything.",
      schedule_call: "Awesome — here's our calendar: https://cal.com/andrew-simpson-gvo4qi/30min",
      send_tips: "Here are some quick tips:\n\n1. Keep demos under 10 steps\n2. Use clear annotations\n3. Start with your product's \"aha\" moment",
    };
  ...
  const SnippetFloater = () => {
    ...
    return (
      ...
      >
        {snippetMessage}
        <button onClick={clearSnippet} className="ml-2 text-xs font-bold underline">
          ✕
        </button>
      </motion.div>
    );
