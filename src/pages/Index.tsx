  ...
  return (
    <>
      <Helmet>
        ...
        <script data-account-id="0f9dd0dd-0df2-4e45-a60e-8f4e0d9c2bed">
        {`!function(){if(window.HappyLeadWidget?.initialized)return;var u=window.currentUser||window.user||(window.analytics?.user?.())||(window.Intercom?.user)||null;window.HappyLeadConfig={accountId:"0f9dd0dd-0df2-4e45-a60e-8f4e0d9c2bed",user:u?.email?{email:u.email,name:u.name||u.full_name||(u.firstName&&u.lastName?u.firstName+" "+u.lastName:"")||"",company:u.company||u.companyName||""}:null};var s=document.createElement("script");s.src="https://app.gethappylead.com/widget.js?v="+Date.now();s.async=1;s.setAttribute("data-account-id","0f9dd0dd-0df2-4e45-a60e-8f4e0d9c2bed");document.head.appendChild(s)}();`}
        </script>
        <style>{`
